...
class TestBlipTVEpisodeFeedsScraper(BaseTestCase.BaseTestCase):
    ...
    def test_plugin_should_list_new_shows_list_correctly(self):
    ...
    def test_plugin_should_list_popular_shows_list_correctly(self):
        self.navigation.listMenu({"scraper": "popular_shows", "path": "/root/explore/popshows"})
