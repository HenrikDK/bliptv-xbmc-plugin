...
class TestBlipTVShowFeedsScraper(BaseTestCase.BaseTestCase):
    ...
    def test_plugin_should_list_user_favorite_shows_categories_folder_correctly(self):
        self.navigation.listMenu({"scraper": "favorites", "path": "/root/explore/browse"})
    ...
    def test_plugin_should_list_user_favorite_show_category_show_list_correctly(self):
        self.navigation.listMenu({"scraper": "favorites", "path": "/root/explore/browse", "category": "/music-videos"})
